...
<div class="w-nav navbar" data-collapse="medium" data-animation="default" data-duration="400" data-contain="1">
    <div class="w-container">
      ...
      <nav class="w-nav-menu open-menu" role="navigation"><a class="w-nav-link nav-link" href="http://joinmyteam.co#how-it-works">How it Works</a><a class="w-nav-link nav-link" href="index#current-course">Programs</a><a class="w-nav-link nav-link" href="about">About</a><a class="w-nav-link nav-link" href="http://blog.joinmyteam.co">Blog</a>
      </nav>
