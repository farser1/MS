...
<div class="scn_intro">
    ...
    <div class="scn_popularcourses" id="weight-loss">
            ...
            <div class="blk_course">
              ...
              <div class="blk_coursetitle">
                ...
                <div class="blk_coursedetail">
                  ...
                  <a class="button btn_grey btn_learnmore" href="weight-loss-made-simple.php">Learn more</a>
                </div>
              </div>
            </div>
          </div>
...
<div class="w-col w-col-4">
            <div class="blk_course">
              ...
              <div class="blk_coursetitle">
                ...
                <div class="blk_coursedetail">
                  <ul class="list_courses">
                    <li class="list_course">
                      <div class="txt_coursesummary">A strength and power course which builds size and shape.</div>
                    </li>
                    <li>
                      <div class="txt_coursesummary txt_coursesum_border">Gym or weight set required</div>
                    </li>
                  </ul>
                  <a class="button btn_grey btn_learnmore" href="strength-size.php">Learn more</a>
 </div>
              </div>
            </div>
          </div>
            ...
            <div class="blk_course">
              ...
              <div class="blk_coursetitle">
                <div class="blk_trainer">
                  <div class="w-row row_courses">
                    <div class="w-col w-col-3 w-col-small-6 w-col-tiny-6">
                      <img class="img_trainermini" src="images/Zoe_Mini.png" width="50" height="50" alt="52f37fca73df7f296b000afa_Zoe_Mini.png">
                    </div>
                    <div class="w-col w-col-9 w-col-small-6 w-col-tiny-6">
                      <div class="txt_trainerbio1">By Zoe Assirati&nbsp;
                        <br>Womens Coach</div>
                    </div>
                  </div>
                </div>
    ...
    <div class="scn_popularcourses scn_white" id="definition-strength">
      <div class="w-container ctr_popularcourses last">
        <h1>Coming Soon</h1>
        <div class="w-row row_popularcourses">
          <div class="w-col w-col-4">
            <div class="blk_course">
            ...
            <div class="blk_course">
              ...
              <div class="blk_coursetitle">
                ...
                <div class="blk_coursedetail">
                  <ul class="list_courses">
                    <li class="list_course">
                      <div class="txt_coursesummary">A high intensity course to shed fat whilst getting seriously fit.</div>
                    </li>
                    <li>
                      <div class="txt_coursesummary txt_coursesum_border">No gym access required</div>
                    </li>
            ...
            <div class="blk_course">
              ...
              <div class="blk_coursetitle">
                ...
                <div class="blk_coursedetail">
                  <ul class="list_courses">
                    <li class="list_course">
                      <div class="txt_coursesummary">A unisex bodybuilding course for achieving maximum size.</div>
                    </li>
                    <li>
                      <div class="txt_coursesummary txt_coursesum_border">No gym access required</div>
                    </li>
        ...
        <div class="w-row row_popularcourses row_last">
          <div class="w-col w-col-4">
            <div class="blk_course">
              ...
              <div class="blk_coursetitle">
                ...
                <div class="blk_coursedetail">
                  <ul class="list_courses">
                    <li class="list_course">
                      <div class="txt_coursesummary">For anyone wanting to take running to the next level.</div>
                    </li>
                    <li>
                      <div class="txt_coursesummary txt_coursesum_border">No gym access required</div>
                    </li>
            ...
            <div class="blk_course">
              ...
              <div class="blk_coursetitle">
                ...
                <div class="blk_coursedetail">
                  <ul class="list_courses">
                    <li class="list_course">
                      <div class="txt_coursesummary">Intensive preparation for any triathlon competition.</div>
                    </li>
                    <li>
                      <div class="txt_coursesummary txt_coursesum_border">No gym access required</div>
                    </li>
            ...
            <div class="blk_course">
              ...
              <div class="blk_coursetitle">
                ...
                <div class="blk_coursedetail">
                  <ul class="list_courses">
                    <li class="list_course">
                      <div class="txt_coursesummary">The ultimate training for the infamous Tough Mudder.</div>
                    </li>
                    <li>
                      <div class="txt_coursesummary txt_coursesum_border">No gym access required</div>
                    </li>
